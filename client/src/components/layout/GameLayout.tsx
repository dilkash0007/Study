...
const routeBackgrounds: Record<string, string> = {
  ...
  "/study-arena":
    "bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#480a0a] via-[#270f1c] to-[#0d0a14]",
  "/quests":
    "bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#063d69] via-[#091b3a] to-[#0d0a14]",
  "/social":
    "bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#4b0f69] via-[#1f0e3a] to-[#0d0a14]",
  "/leaderboard":
    "bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#2d4b0f] via-[#152a1c] to-[#0d0a14]",
  "/achievements":
    "bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#6d3102] via-[#3a1c09] to-[#0d0a14]",
  "/profile":
    "bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#4f0275] via-[#1e0c30] to-[#0d0a14]",
  "/subject-settings":
    "bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#275402] via-[#192a15] to-[#0d0a14]",
};
...
const GameLayout = () => {
  ...
  return (
    <div
      className={`min-h-screen w-full flex flex-col ${bgClass} transition-colors duration-1000`}
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          ...
          animate-subtle-rotate opacity-50"
        ></div>
      </div>
